      ...
      <div className="text-center md:text-left md:w-1/2">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:gap-4">
          <div className="flex justify-center md:justify-start items-center py-4">
           <Link href='/contact'>
           <button className="bg-main px-8 text-[16px] flex items-center duration-300 gap-2 justify-between hover:bg-white hover:border-[1px] border-[1px] hover:border-main hover:text-black py-2 rounded-full font-semibold text-white hover:bg-opacity-90">
              Hire Me
            </button>
            </Link>
          </div>
